...
- [ ] Integration tests identified for all user workflows
- [ ] Unit tests identified for business logic
- [ ] TDD workflow: Tests → Fail → Implement → Pass

### Principle II: Type Safety First
- [ ] All code uses strict typing (no `any` or equivalent without justification)
- [ ] Types generated from schemas where applicable
- [ ] Input validation schemas defined for all user inputs

### Principle III: Security by Default
- [ ] Authentication verification planned for all protected routes
- [ ] Input validation planned for all user inputs
- [ ] No sensitive data in logs or version control

### Principle IV: Code Quality & Maintainability
- [ ] Code review process planned
- [ ] Test coverage targets set (≥80% unit, ≥70% integration)
- [ ] Linter configuration verified
...
- Load `.agent/templates/tasks-template.md` as base
...
---
*Based on Constitution — See `.agent/memory/constitution.md`*
