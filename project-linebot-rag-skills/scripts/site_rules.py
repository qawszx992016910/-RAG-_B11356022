...
SITE_RULES: dict[str, dict] = {
    ...
    "howtostudykorean.com": {
        ...
        "remove_selectors": [
            "nav", ".sidebar", ".widget", ".sharedaddy",
            ".jp-relatedposts", "footer", "[class*='comment']",
            ".wpa-ad", "script", "style",
        ],
        "wait_selector": ".entry-content",
    },
    "koreangrammarguide.com": {
        "main_selector": "article.post, .entry-content",
        "remove_selectors": ["nav", ".sidebar", "footer", "[class*='comment']"],
        "wait_selector": None,
    },
}
